...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, SessionEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.ragchat.common.event,com.rag.sessionservice.event,com.rag.messageservice.event");
        // Add type mapping for improved compatibility
        props.put(JsonDeserializer.TYPE_MAPPINGS, "com.rag.sessionservice.event.SessionEvent:com.ragchat.common.event.SessionEvent");

        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SessionEvent> kafkaListenerContainerFactory() {
